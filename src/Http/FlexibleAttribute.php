...
namespace Tolle\NovaFlexibleContent\Http;
...
class FlexibleAttribute
{
     ...
     * @var string
     */
    public const REGISTER = '___nova_flexible_content_fields';
     ...
     * @var string
     */
    public const FILE_INDICATOR = '___upload-';
     ...
     * @param  mixed  $key
     * @param  bool  $upload
     * @return \Tolle\NovaFlexibleContent\Http\FlexibleAttribute
     */
