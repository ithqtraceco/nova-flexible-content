...
use Tolle\NovaFlexibleContent\Http\ScopedRequest;
use Tolle\NovaFlexibleContent\Layouts\Collection as LayoutsCollection;
use Tolle\NovaFlexibleContent\Layouts\Layout;
use Tolle\NovaFlexibleContent\Layouts\LayoutInterface;
use Tolle\NovaFlexibleContent\Layouts\Preset;
use Tolle\NovaFlexibleContent\Value\Resolver;
use Tolle\NovaFlexibleContent\Value\ResolverInterface;
...
class Flexible extends Field
{
     ...
     *
     * @var Tolle\NovaFlexibleContent\Layouts\Collection
     */
    protected $layouts;
     ...
     *
     * @var Tolle\NovaFlexibleContent\Value\ResolverInterface
     */
    protected $resolver;
     ...
     *
     * @param  Tolle\NovaFlexibleContent\Layouts\LayoutInterface  $layout
     * @return void
     */
     ...
     *
     * @param  string  $key
     * @return \Tolle\NovaFlexibleContent\Layouts\Layout
     */
     ...
     *
     * @param  string  $key
     * @return null|\Tolle\NovaFlexibleContent\Http\FlexibleAttribute
     */
    ...
    protected function registerOriginModel($model)
    {
        if (is_a($model, \Laravel\Nova\Resource::class)) {
            $model = $model->model();
        } elseif (is_a($model, \Tolle\NovaPage\Pages\Template::class)) {
